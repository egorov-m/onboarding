...
S3_PRESIGNED_PUT_OBJECT_EXPIRES_MINUTES = int(environ.get("S3_PRESIGNED_PUT_OBJECT_EXPIRES_MINUTES", "5"))
S3_PRESIGNED_GET_OBJECT_EXPIRES_MINUTES = int(environ.get("S3_PRESIGNED_GET_OBJECT_EXPIRES_MINUTES", "1440"))

MAX_COUNT_ATTACHED_BLOB_BY_BOARD_STEP = int(environ.get("MAX_COUNT_ATTACHED_BLOB_BY_BOARD_STEP", "5"))
